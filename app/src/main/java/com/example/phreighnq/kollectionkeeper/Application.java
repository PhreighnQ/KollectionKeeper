...
public class Application extends android.app.Application {
    ...
    public static final String TAG = "KollectionKeeper";
    private static final String DATABASE_NAME = "kollections";
...
//    private static final String PREF_LAST_RCVD_FB_ACCESS_TOKEN = "LastReceivedFbAccessToken";
    ...
    public class Views{
        public static final String CollectionsByAlphabet = "Collections/byAlphabet";
    }
...
//    private Replication pushReplication;
    ...
    private void initDatabase() {
        ...
        com.couchbase.lite.View viewCollectionsByAlphabet = database.getView(Views.CollectionsByAlphabet);
        viewCollectionsByAlphabet.setMap(new Mapper() {
            @Override
            public void map(Map<String, Object> document, Emitter emitter) {
                Object name = document.get("name");
                Object type = document.get("type");
                if (name != null && type != null && type.toString() == "collection") {
                    emitter.emit(name.toString(), null);
                }
            }
        }, "1.0");
    }
